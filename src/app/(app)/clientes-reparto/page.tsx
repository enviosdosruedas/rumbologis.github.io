...
export default function ClientesRepartoPage() {
  ...
  const fetchClientesReparto = useCallback(async () => {
    ...
    // Fetch related client data using a JOIN-like select
    const { data, error } = await supabase
  ...
  const handleCreateClienteReparto = async (formData: ClienteRepartoFormData) => {
    ...
    // The 'id' field is not included in formData as it's auto-generated by Supabase.
  ...
  return (
    <div className="space-y-6">
      <CrudPageHeader
        ...
        createDialogComponent={<CreateClienteRepartoDialog onCreate={handleCreateClienteReparto} clientes={clientes} />}
      />
